...
if __name__ == '__main__':
    ...
    create_engine('homestead', 'secret', 'homestead', '192.168.10.10')
    update('drop table if exists usertest')
    update('create table usertest (id int primary key, name text, email text, passwd text, last_modified real)')
    import doctest
    doctest.testmod()
